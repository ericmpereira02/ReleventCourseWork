...
public class HashTable<Key, Value> {
	...
	public HashTable(int M) { // M is the number of linked lists the table should be initialized with
		int N = 0;
		this.M = M;
		this.N = N;
	 ...
	 * @return String string array of list
	 */
	public String[] getList(Key key) {
		return this.lists[hash(key)].getList();
	}
